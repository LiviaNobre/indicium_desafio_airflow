...
def extract_data_to_csv():
    ...
    conn = sqlite3.connect('/mnt/c/Users/Home/Desktop/Desafio_7/airflow_tooltorial/data/Northwind_small.sqlite')
    ...
    df.to_csv('/mnt/c/Users/Home/Desktop/Desafio_7/airflow_tooltorial/airflow-data/dags/arquivo.csv', index=False)
...
def process_orders():
    caminho_sqlite = r"/mnt/c/Users/Home/Desktop/Desafio_7/airflow_tooltorial/data/Northwind_small.sqlite"
    ...
    with open('/mnt/c/Users/Home/Desktop/Desafio_7/airflow_tooltorial/airflow-data/dags/count.txt', 'w') as f:
...
def export_final_answer():
    ...
    # Import count
    with open('/mnt/c/Users/Home/Desktop/Desafio_7/airflow_tooltorial/airflow-data/dags/count.txt') as f:
        count = f.readlines()[0]
    ...
    with open("/mnt/c/Users/Home/Desktop/Desafio_7/airflow_tooltorial/airflow-data/dags/final_output.txt","w") as f:
        f.write(base64_message)
    return None
